...
const STEPS: Step[] = [
  {
    ...
    caption: "We audit your market position, competitors, and target segments across your priority regions in the UK, US, and UAE.",
    image: stepDiscover,
  },
  {
    percent: "50",
    title: "Wireframes & User Flows",
    caption: "We design user journeys tailored to real customer behaviour, with a mobile-first, accessibility-led approach.",
...
const WorkStepsProject = () => {
  ...
  const jsonLd = useMemo(
    () => ({
      ...
      "@type": "HowTo",
      name: "How We Work With Global Businesses",
      step: STEPS.map((s, i) => ({
        "@type": "HowToStep",
        position: i + 1,
        name: s.title,
