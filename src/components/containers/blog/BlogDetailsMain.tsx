        ...
        <div className="row g-4 g-xl-5">
          <div className="col-12 col-xl-8">
            <article
              className={[
                "blog-article__paper",
                post.hideBlogBanner ? "blog-article__paper--quantel-html" : "",
              ]
                .filter(Boolean)
                .join(" ")}
            >
              <div
                className={[
                  ...
                  "bd-mdx",
                  "bd-prose",
                  post.hideBlogBanner ? "blog-article__body--quantel-html" : "",
                ]
                  .filter(Boolean)
                  .join(" ")}
              >
              ...
              <footer className="blog-article__footer">
                ...
                {/* Brand social profiles — mirrors `Footer` so blog readers
                    ...
                    exist in the slim icon subset (`linkedin-in`, `instagram`). */}
