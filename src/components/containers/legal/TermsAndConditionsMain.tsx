...
/**
 * Long-form Terms & Conditions for Quantel Solutions.
 * Covers website use plus the engagement model commonly used for the company's
 * technology services. Written under the laws of England and Wales.
 */
          ...
          <div className="col-12 col-lg-10 col-xl-9">
            <article className="legal-page__content fade-top">
              ...
              <p className="primary-text">
                ...
                use of the website <Link href="/">quantel.uk</Link> and the
                technology services provided by{" "}
                <strong>Quantel Solutions</strong> (&ldquo;Quantel&rdquo;,
              ...
              <p>
                Quantel Solutions is a technology company based at{" "}
              ...
              <p>
                Quantel provides technology and digital services including but not
                limited to SaaS product development, white-label platforms, AI and
                automation, web and mobile app development, e-commerce, ERP, UI/UX
                design, and digital marketing (SEO, paid media, and social).
                The specific scope, deliverables, timeline,
              ...
              <p>
                Quotations and proposals issued by Quantel are valid for{" "}
              ...
              <ul className="legal-page__list">
                <li>
                  Fees are quoted in British Pounds (GBP) unless stated
                  otherwise and are exclusive of any applicable taxes (e.g.
                  VAT), bank charges, third-party media spend, or licence
                  fees.
                </li>
                <li>
              ...
              <ul className="legal-page__list">
                <li>
                  ...
                  Quantel and is protected by UK and international
                ...
                <li>
                  ...
                  frameworks owned by Quantel.
                </li>
                <li>
                  Quantel retains the right to use deliverables, project
              ...
              <p>
                ...
                proven strategies and best practices, Quantel does not
              ...
              <p>
                You agree to indemnify and hold Quantel harmless from any
              ...
              <p>
                ...
                England and Wales. The parties agree to first attempt to resolve any
