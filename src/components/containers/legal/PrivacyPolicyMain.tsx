...
/**
 * Long-form Privacy Policy for Quantel Solutions.
 * Written to align with the UK GDPR and the Data Protection Act 2018,
 * plus common cookie / analytics disclosures for a technology company website.
 */
          ...
          <div className="col-12 col-lg-10 col-xl-9">
            <article className="legal-page__content fade-top">
              ...
              <p className="primary-text">
                This Privacy Policy explains how <strong>Quantel Solutions</strong>{" "}
                (&ldquo;Quantel&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;, or
                &ldquo;us&rdquo;) collects, uses, discloses, and protects your
                personal data when you visit{" "}
                <Link href="/">quantel.uk</Link>, contact us, or engage our
                technology services. We are committed to handling your
                personal data in accordance with the{" "}
                <em>UK GDPR and the Data Protection Act 2018</em> and other
                applicable laws.
              </p>
              ...
              <ul className="legal-page__list">
                ...
                <li>
                  ...
                  the UK GDPR. You can opt out at any time.
                </li>
                <li>
              ...
              <ul className="legal-page__list">
                ...
                <li>
                  <strong>Authorities</strong> when required by UK law,
                  a court order, or a legitimate request from a regulator.
                </li>
              </ul>
              <p>
                Where personal data is transferred outside the United Kingdom (for
              ...
              <h2 className="legal-page__h2">8. Your rights under the UK GDPR</h2>
              <p>
                Subject to certain conditions and exceptions under the UK GDPR,
              ...
              <ul className="legal-page__list">
                ...
                <li>
                  ...
                  Office (ICO) if you believe your rights have been infringed.
                </li>
              </ul>
              <p>
